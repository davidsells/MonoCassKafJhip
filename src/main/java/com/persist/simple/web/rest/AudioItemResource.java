...
import com.persist.simple.service.AudioItemService;
...
public class AudioItemResource {
    ...
    private final AudioItemService audioItemService;

    private final AudioItemRepository audioItemRepository;

    public AudioItemResource(AudioItemService audioItemService, AudioItemRepository audioItemRepository) {
        this.audioItemService = audioItemService;
    ...
    public ResponseEntity<AudioItem> createAudioItem(@RequestBody AudioItem audioItem) throws URISyntaxException {
        ...
        AudioItem result = audioItemService.save(audioItem);
    ...
    public ResponseEntity<AudioItem> updateAudioItem(
        ...
        AudioItem result = audioItemService.update(audioItem);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<AudioItem> partialUpdateAudioItem(
        ...
        Optional<AudioItem> result = audioItemService.partialUpdate(audioItem);
    ...
    public List<AudioItem> getAllAudioItems() {
        ...
        return audioItemService.findAll();
    }
    ...
    public ResponseEntity<AudioItem> getAudioItem(@PathVariable UUID id) {
        ...
        Optional<AudioItem> audioItem = audioItemService.findOne(id);
