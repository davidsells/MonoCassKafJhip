...
import com.persist.simple.config.KafkaSseConsumer;
import com.persist.simple.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/mono-cassandra-kafka")
public class MonoCassandraKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MonoCassandraKafkaResource.class);
    ...
    public MonoCassandraKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
