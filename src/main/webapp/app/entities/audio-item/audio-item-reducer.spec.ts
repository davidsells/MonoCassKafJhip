...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AUDIOITEM_LIST actions', async () => {
    ...
    it('dispatches FETCH_AUDIOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AUDIOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AUDIOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AUDIOITEM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AUDIOITEM actions', async () => {
      const expectedActions = [
        {
